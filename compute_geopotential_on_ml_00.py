...
from eccodes import (codes_index_new_from_file, codes_index_get, codes_get,
                     ...
                     codes_write)
import gribs_merge # import file gribs_merge.py
import os
...
def main():
    ...
    fout.close()
####################################################
# Added by me 08.11.2022
    dir='/home/kmnuser/Documents/Andrey/gh-137'
    dir_additional=args.dirname
    in_file=dir_additional+'/'+'z_out.grib'
    out_file=dir_additional+'/'+'z_out_scale.grib'

    subprocess.call(['grib_set', '-s', 'scaleValuesBy=0.102',  in_file,  out_file])
    subprocess.call(['python3', dir+'/'+'gribs_merge_2.py'])
